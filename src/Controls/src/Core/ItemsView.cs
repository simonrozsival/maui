...
namespace Microsoft.Maui.Controls
{
	...
	public abstract class ItemsView<[DynamicallyAccessedMembers(BindableProperty.DeclaringTypeMembers | DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)] TVisual> : View, ITemplatedItemsView<TVisual> where TVisual : BindableObject
	{
		/*
