...
namespace Microsoft.Maui.Controls
{
	...
	public class ShellItem : ShellGroupItem, IShellItemController, IElementConfiguration<ShellItem>, IPropertyPropagationController, IVisualTreeElement
	{
		...
		internal static ShellItem CreateFromShellSection(ShellSection shellSection)
		{
			...
			result.SetBinding(TitleProperty,
				TypedBinding<ShellSection>.Create(
					ShellSection.TitleProperty,
					static section => section.Title,
					mode: BindingMode.OneWay,
					source: shellSection));

			result.SetBinding(IconProperty,
				TypedBinding<ShellSection>.Create(
					ShellSection.IconProperty,
					static section => section.Icon,
					mode: BindingMode.OneWay,
					source: shellSection));

			result.SetBinding(FlyoutDisplayOptionsProperty,
				TypedBinding<ShellSection>.Create(
					ShellSection.FlyoutDisplayOptionsProperty,
					static section => section.FlyoutDisplayOptions,
					mode: BindingMode.OneTime,
					source: shellSection));

			result.SetBinding(FlyoutIconProperty,
				TypedBinding<ShellSection>.Create(
					ShellSection.FlyoutIconProperty,
					static section => section.FlyoutIcon,
					source: shellSection));
