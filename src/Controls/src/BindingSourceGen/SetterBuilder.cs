...
public sealed class SetterBuilder
{
    ...
    private SetterBuilder(string sourceVariableName, string valueVariableName)
    {
    ...
    private void AddPart(IPathPart nextPart)
    {
    ...
    private void AddIsExpression(string target)
    {
