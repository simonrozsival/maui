...
namespace Microsoft.Maui.Controls.Build.Tasks
{
	...
	class BuildExceptionCode
	{
		...
		public static BuildExceptionCode BindingShouldNotInheritDataType = new BuildExceptionCode("XC", 0026, nameof(BindingShouldNotInheritDataType), "https://learn.microsoft.com/dotnet/maui/fundamentals/data-binding/compiled-bindings"); //warning
